...
const AGENT_CONDUCT =
  ...
  "If a tool is unavailable or refused, say so plainly and explain what you could not do. " +
  "If you are missing information you genuinely need, ask ONCE with a form or choice intent, then continue with the answer. " +
...
const GENERAL_AGENTS = [
  {
    ...
    systemPrompt:
      "You gather information. Use the read tools you have been granted to find what the goal needs — public web search, calendar reads, or anything else listed. " +
      "When the goal depends on a choice only the human should make, present the real options you found as a choice intent rather than deciding for them. " +
      AGENT_CONDUCT
  },
  {
    name: "Writer",
